...
export default function Inicio() {
    ...
    return (
            ...
            <section  className='text-white font-monospace'>
            ...
            <div className="col-sm-7 col-md-5 text-white font-monospace">
            <h5>RICK SANCHEZ</h5>
        ...
        <section>
        <div>
        <h3 className=" text-center text-white font-monospace">Creadores</h3>
        </div>
